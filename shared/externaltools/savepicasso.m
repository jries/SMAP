...
%edited 2020 by ries@embl.de to include export of z coordinates.
...
locs.lpz = double(locs.lpz);
locs.z = double(locs.z);
...
if ~isempty(locs.z)
    doubleType=H5T.copy('H5T_NATIVE_DOUBLE');
    sz(6)     =H5T.get_size(doubleType);
    doubleType=H5T.copy('H5T_NATIVE_DOUBLE');
    sz(7)     =H5T.get_size(doubleType);
    offset(2:7)=cumsum(sz(1:6));
end
...
if ~isempty(locs.z)
    H5T.insert (memtype,...
        'z',offset(6), doubleType);
    H5T.insert (memtype,...
        'lpz',offset(7), doubleType);
end
...
if ~isempty(locs.z)
    H5T.insert (filetype, 'z',offset(6), doubleType);
    H5T.insert (filetype, 'lpz',offset(7), doubleType);
end
...
fprintf(fileID,'Generated by: Picasso Convert from SMAP\n');
fclose(fileID);
end