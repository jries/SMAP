...
%
% Requirment:
%   * SMAP (https://github.com/jries/SMAP/tree/develop)
%
% Output files:
%   * [analysisID]_par.mat: parameters used for the analysis.
%   * [analysisID]_preReg.mat: intermediate results of pre-registered pores.
%   * [analysisID]_LLMatrix.mat: intermediate results of the log-likelihood matrix.
%   * [analysisID]_initialTemp.mat: intermediate results of the initial template.
...
par.sml_source = 'dataSourceID';             % define an optional ID to represent the source _sml.mat file. This is not used in the following script.

% Example:
% par.sml_driveLoad = 'D';
% par.sml_dirPath = ':\myData\';
% par.sml_fileName = 'nup96_sml.mat';
% par.sml_source = 'dataSet1';
%
% In this example, the file 'D:\myData\nup96_sml.mat' will be used as the data source.

% data save related
% locprecnm: localization presicion in the unit of nanometer.
par.save_wd = ':\save\to\this\folder\';     % working directory without its drive letter
par.save_drive = 'D';                       % the letter of the drive where the working directory is.
par.save_name = 'analysisID';               % define the ID (used when saving) of the analysis here.

% Example:
% par.save_wd = ':\particleFusion\analysis\';
% par.save_drive = 'D';
% par.save_name = 'analysis1';
%
% In this example, the output files will be saved as 'D:\particleFusion\analysis\analysis1_xxx.mat'.

% parameters of the particle fusion
par.parFu_rng = 211023;                     % user-specified seed for the RNG.
par.parFu_path2Mod = "c:\whereTheSMAPFolderIs\SMAP\LocMoFit\models\NPCPointModel_flexible2.m"; % path to the dual-ring model.

% Example:
% If your SMAP directory is 'C:\git\SMAP', please set as the following:
% par.parFu_path2Mod = "C:\git\SMAP\LocMoFit\models\NPCPointModel_flexible2.m";
...
if par.parFu_preRegistration
    % set up the fitter for the pre-registration
