...
:::{important}
If you would just like to try LocMoFit out, the information provided here is not essential. You can directly start with the tutorial {doc}`/tutorial/quickstart` and consult this page later.
:::
