...
%     Similar to RoiCutterWF_group, but which localizations to merge is not
%     determined on the fly but given as an input. This plugin cuts out
%     regions of interest of a defined size around the candidate positions
%     and passes these on to the fitter';
    properties
        loc_ROIsize
        preview
        temprois
...
pard.plugininfo.description='Similar to RoiCutterWF_group, but which localizations to merge is not determined on the fly but given as an input. This plugin cuts out regions of interest of a defined size around the candidate positions and passes these on to the fitter';
end