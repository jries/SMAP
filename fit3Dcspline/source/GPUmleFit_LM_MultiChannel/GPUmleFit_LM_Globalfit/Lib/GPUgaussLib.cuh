...
__device__ inline void kernel_DerivativeGauss2D_sigmaxy(int ii, int jj, float PSFSigma,float* theta, float *dudt, float *model) {
	float PSFx, PSFy;
	PSFx=kernel_IntGauss1D(ii, theta[0], theta[4]);
...
//*****************************************************************************************************************************
__device__ inline void kernel_sum_reduce(const int BlockSize, const int pixelIndex, volatile float *A, volatile float *Aout) {
...
__device__ inline void kernel_min_reduce(const int BlockSize, const int pixelIndex, volatile float *A, volatile float *Aout) {
...
__device__ inline void kernel_max_reduce(const int BlockSize, const int pixelIndex, volatile float *A, volatile float *Aout) {
...
__device__ inline void kernel_sum_reduce_dual(const int BlockSize, const int pixelIndex, volatile float *A, volatile float *B, volatile float *Aout, volatile float *Bout) {
    /* Calculate the sum by performing cascaded sums across threads
